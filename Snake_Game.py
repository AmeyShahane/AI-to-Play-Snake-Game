"""
A Fun Snake Game in Python(XDXDXD) using Pygame.
...
class SnakeGame():
	...
	def __init__(self, width = 640, hight = 480):
		...
		self.head = Point(self.width/2, self.hight/2)
	...
	def _place_food(self):
		...
		y = random.randint(0, (self.hight-BLOCK_SIZE )//BLOCK_SIZE )*BLOCK_SIZE
		self.food = Point(x,y)
	...
	def _is_collision(self):
		if self.head.x > self.width-BLOCK_SIZE or self.head.x < 0 or self.head.y > self.hight-BLOCK_SIZE or self.head.y < 0:
			return True
